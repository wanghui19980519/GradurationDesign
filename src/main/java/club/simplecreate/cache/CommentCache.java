...
public class CommentCache {
    ...
    public void insertComment(Comment comment){
        ...
        //同时该作者的新消息数量加一，
        redisTemplate.opsForValue().increment("NEWMESSAGENUMS:"+comment.getReceiverId());
        //并且将评论通知加入其通知列表
        CommentMessage message=new CommentMessage(comment);
        redisTemplate.opsForList().leftPush("COMMENTMESSAGE:"+comment.getReceiverId(),message);
    }
